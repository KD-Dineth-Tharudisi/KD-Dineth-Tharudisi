...
Field Related skills : Arduino and hardware programming, C#, SQL, .NET Core, ASP.NET MVC, ASPX, PostgreSQL, XML (serialization, Mapping), SCSS, HTML5, JS, Mobile App (Kotlin/ Java,Android studio), API, T-SQL, ETL (Data warehousing & analytics), Performance tuning, CMSs, PHP, Crystal Report, software modernization, version control (Git Lab, Git Hub), Figma, Apache JMeter™, DNS Management, System Maintenance & Troubleshooting
<br><br>
